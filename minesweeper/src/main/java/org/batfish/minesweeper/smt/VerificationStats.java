...
public class VerificationStats {
  ...
  // VERIBOOST_ADD_BEGIN
  private static final String PROP_MINCUT_TIME = "mincutTime";

  private static final String PROP_PRUNE_TIME = "pruneTime";

  private static final String PROP_COMPRESSION_TIME = "compressionTime";

  private static final String PROP_TOLERANCE_SPACE_ORIGIN = "toleranceSpaceOrigin";

  private static final String PROP_TOLERANCE_SPACE_PRUNE = "toleranceSpacePrune";

  private static final String PROP_TOLERANCE_SPACE_COMPRESSION = "toleranceSpaceCompression";

  private static final String PROP_IS_MINCUT_VERIFIED = "isMincutVerified";

  private double _mincutTime;

  private double _pruneTime;

  private double _compressionTime;

  private double _toleranceSpaceOrigin;

  private double _toleranceSpacePrune;

  private double _toleranceSpaceCompression;

  private boolean _isMincutVerified;
  ...
  static VerificationStats combineAll(List<VerificationStats> allStats, long totalTime) {
    ...
    //VERIBOOST_ADD_BEGIN
    newStats.setMincutTime(allStats.get(0).getMincutTime());
    newStats.setPruneTime(allStats.get(0).getPruneTime());
    newStats.setCompressionTime(allStats.get(0).getCompressionTime());
    newStats.setToleranceSpaceOrigin(allStats.get(0).getToleranceSpaceOrigin());
    newStats.setToleranceSpacePrune(allStats.get(0).getToleranceSpacePrune());
    newStats.setToleranceSpaceCompression(allStats.get(0).getToleranceSpaceCompression());
    //VERIBOOST_ADD_END
    return newStats;
  }

  //VERIBOOST_ADD_BEGIN
  @JsonProperty(PROP_IS_MINCUT_VERIFIED)
  public boolean getMincutVerified() {
    return _isMincutVerified;
  }

  @JsonProperty(PROP_IS_MINCUT_VERIFIED)
  public void setMincutVerified(boolean _verified) {
    this._isMincutVerified = _verified;
  }


  @JsonProperty(PROP_MINCUT_TIME)
  public double getMincutTime() {
    return _mincutTime;
  }

  @JsonProperty(PROP_MINCUT_TIME)
  public void setMincutTime(double _mincutTime) {
    this._mincutTime = _mincutTime;
  }

  @JsonProperty(PROP_PRUNE_TIME)
  public double getPruneTime() {
    return _pruneTime;
  }

  @JsonProperty(PROP_PRUNE_TIME)
  public void setPruneTime(double _pruneTime) {
    this._pruneTime = _pruneTime;
  }

  @JsonProperty(PROP_COMPRESSION_TIME)
  public double getCompressionTime() {
    return _compressionTime;
  }

  @JsonProperty(PROP_COMPRESSION_TIME)
  public void setCompressionTime(double _compressionTime) {
    this._compressionTime = _compressionTime;
  }

  @JsonProperty(PROP_TOLERANCE_SPACE_ORIGIN)
  public double getToleranceSpaceOrigin() {
    return _toleranceSpaceOrigin;
  }

  @JsonProperty(PROP_TOLERANCE_SPACE_ORIGIN)
  public void setToleranceSpaceOrigin(double _toleranceSpaceOrigin) {
    this._toleranceSpaceOrigin = _toleranceSpaceOrigin;
  }

  @JsonProperty(PROP_TOLERANCE_SPACE_PRUNE)
  public double getToleranceSpacePrune() {
    return _toleranceSpacePrune;
  }

  @JsonProperty(PROP_TOLERANCE_SPACE_PRUNE)
  public void setToleranceSpacePrune(double _toleranceSpacePrune) {
    this._toleranceSpacePrune = _toleranceSpacePrune;
  }

  @JsonProperty(PROP_TOLERANCE_SPACE_COMPRESSION)
  public double getToleranceSpaceCompression() {
    return _toleranceSpaceCompression;
  }

  @JsonProperty(PROP_TOLERANCE_SPACE_COMPRESSION)
  public void setToleranceSpaceCompression(double _toleranceSpaceCompression) {
    this._toleranceSpaceCompression = _toleranceSpaceCompression;
  }
