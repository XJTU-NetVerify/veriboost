...
set output 'results/MicroBenchMark-MaximumNumber-SymbolicNodes-CCDF.pdf'
set size 1, 0.9
...
plot \
  '< sort -n -k3,3 data/MicroBenchMark-MaximumNumber-SymbolicNodes-CCDF.dat' using ($1*100):(100.*(N-($0+1)+1)/N) with lines ls 5 lw 7 dt 1 title 'Both Methods'