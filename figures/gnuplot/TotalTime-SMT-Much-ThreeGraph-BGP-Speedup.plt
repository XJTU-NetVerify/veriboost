...
# set format y "10^{%L}"
# set mytics 10
set key width 10 Left vertical maxrows 1 reverse samplen 1 at screen 0.8, 1.07  font ',11' spacing 2
set bmargin screen 0.33
set tmargin at screen 0.9
set rmargin screen 0.93

set output 'results/TotalTime-SMT-Much-ThreeGraph-BGP-Speedup.pdf'
set style data histogram
set style histogram clustered gap 1 title offset 0,-1

set multiplot layout 1,3 margins 0.07, 0.97, 0.23, 0.81 spacing 0.05

set ylabel "Speedup" offset 0.5,0.5 font ',11'
set size 1, 0.9
set offsets 0.5,0.5,0,0
set label 'k=1' at screen 0.140,0.74 center font ',11'
set ytics 2
plot 'data/TotalTime-SMT-BGP-Much-K1.dat' u ($2/$3):xtic(1) w histogram fs pattern 3 ls 2 t'NetSMT', \
	'' u ($2/$4) w histogram fs pattern 2 ls 3 t'VeriBoost'
...
set ytics 5
plot 'data/TotalTime-SMT-BGP-Much-K2.dat' u ($2/$3):xtic(1) w histogram fs pattern 3 ls 2 t'NetSMT', \
	'' u ($2/$4) w histogram fs pattern 2 ls 3 t'VeriBoost'
...
set ytics 10
plot 'data/TotalTime-SMT-BGP-Much-K3.dat' u ($2/$3):xtic(1) w histogram fs pattern 3 ls 2 t'NetSMT', \
	'' u ($2/$4) w histogram fs pattern 2 ls 3 t'VeriBoost'