...
set offsets 5,5,0,0
set key width -0.05 Left vertical maxrows 1 reverse samplen 1 at screen 0.60, 0.94  font ',13' spacing 0.1
set bmargin screen 0.25
set tmargin at screen 0.85
set rmargin screen 0.94

set output 'results/MicroBenchMark-AverageNumber-SymbolicNodes-CCDF.pdf'
set size 1, 0.9

stats 'data/MicroBenchMark-AverageNumber-SymbolicNodes-CCDF.dat' using 1 nooutput
N = STATS_records

plot \
  '< sort -n -k3,3 data/MicroBenchMark-AverageNumber-SymbolicNodes-CCDF.dat' using ($1*100):(100.*(N-($0+1)+1)/N) with lines ls 5 lw 7 dt 1 title 'Both Methods'