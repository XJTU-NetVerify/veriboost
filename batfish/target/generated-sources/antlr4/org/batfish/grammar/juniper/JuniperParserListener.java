...
public interface JuniperParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JuniperParser#flat_statement}.
	 * @param ctx the parse tree
	 */
	void enterFlat_statement(JuniperParser.Flat_statementContext ctx);
	/**
	 * Exit a parse tree produced by {@link JuniperParser#flat_statement}.
	 * @param ctx the parse tree
	 */
	void exitFlat_statement(JuniperParser.Flat_statementContext ctx);
	/**
	 * Enter a parse tree produced by {@link JuniperParser#hierarchical_statement}.
	 * @param ctx the parse tree
	 */
	void enterHierarchical_statement(JuniperParser.Hierarchical_statementContext ctx);
	/**
	 * Exit a parse tree produced by {@link JuniperParser#hierarchical_statement}.
	 * @param ctx the parse tree
	 */
	void exitHierarchical_statement(JuniperParser.Hierarchical_statementContext ctx);
	/**
